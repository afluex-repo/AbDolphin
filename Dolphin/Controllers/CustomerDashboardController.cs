...
{ 
    public class CustomerDashboardController : BaseController
    {
        ...
        public ActionResult UpdatePassword(CustomerDashboard obj)
        {
            ...
            try
            {
                obj.Password = Dolphin.Crypto.Encrypt(obj.Password);
                obj.NewPassword = Dolphin.Crypto.Encrypt(obj.NewPassword);
        ...
        public ActionResult PlotAvailability(CustomerDashboard model)
        {
            #region ddlSiteType
            CustomerDashboard objSiteType = new CustomerDashboard();
            int count1 = 0;
        ...
        public ActionResult GetSitesDetails(string SiteID)
        {
            try
            {
                ...
                List<CustomerDashboard> lstPlcCharge = new List<CustomerDashboard>();
        ...
        [OnAction(ButtonName = "Search")]
        public ActionResult Details(CustomerDashboard model)
        {
            //Master model = new Master();
            List<CustomerDashboard> lst = new List<CustomerDashboard>();
            ...
            #region ddlSite
            int count1 = 0;
            CustomerDashboard objmaster = new CustomerDashboard();
            List<SelectListItem> ddlSite = new List<SelectListItem>();
            DataSet dsSite = model.GetSiteList();
            if (dsSite != null && dsSite.Tables.Count > 0 && dsSite.Tables[0].Rows.Count > 0)
            {
