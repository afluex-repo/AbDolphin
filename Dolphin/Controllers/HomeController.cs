...
using static Dolphin.Models.Common;
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult LoginAction(Home obj)
        {
            ...
            try
            {
                ...
                if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        if (obj.Password == Dolphin.Crypto.Decrypt(ds.Tables[0].Rows[0]["Password"].ToString()))
                        {
        ...
        public ActionResult GetPassword(string LoginId, string MobileNo)
        {
            ...
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    model.Response = "1";
                    TempData["ForgotPass"] = " Password is sent on your registered mobile no !";
                    try
                    {
                        ...
                        BLSMS.SendSMS(MobileNo, "Dear " + FirstName + ",Your Password is : " + Password + ". AB DOLPHIN", TempId);
                    }
                    catch { }
                ...
                {
                    TempData["ForgotPass"] = ds.Tables[0].Rows[0]["ErrorMessage"].ToString();
                }
            }
            return Json(model, JsonRequestBehavior.AllowGet);
        }
