...
namespace Dolphin
{
    static public class BLSMS
    {
        ...
        //static public void SendSMSCust(string Mobile, string Message)
        //{
        //    try
        //    {
        //        string SMSAPI = ConfigurationSettings.AppSettings["SMSAPICu"].ToString();
        //        SMSAPI = SMSAPI.Replace("[AND]", "&");
        //        SMSAPI = SMSAPI.Replace("[MOBILE]", Mobile);
        //        SMSAPI = SMSAPI.Replace("[MESSAGE]", Message);
        ...
        public static string SendSMS2(string User, string password, string senderid, string Mobile_Number, string Message)
        {
         ...
         static public string PayoutRequest(string Name, string Amount)
        {
            string Message = ConfigurationSettings.AppSettings["PayoutRequest"].ToString();
            Message = Message.Replace("[Name]", Name);
